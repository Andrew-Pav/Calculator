...
public class Roman {
    static String [] romanNums = new String[] {
    ...
    public static int getArrabNum(String roman) {
        for (int i = 0; i < romanNums.length; i++) {
    ...
    public static String getRomNumFromArrab(int arrab) {
        String romNum = romanNums[arrab - 1];
        return romNum;
    }
}
